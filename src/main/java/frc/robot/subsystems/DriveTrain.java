...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() {
    ...
    swerve = new Swerve(drives, steers, encoders, gyro, Constants.MODULE_POSITIONS, Constants.MODULE_GAINS, new double[]{Constants.STEER_GAINS_HIGH, Constants.STEER_GAINS_THRESHOLD},Constants.NUMBER_OF_MODULES, Constants.PERCENT_SPEED, Constants.TICKS_PER_FOOT);
  }
